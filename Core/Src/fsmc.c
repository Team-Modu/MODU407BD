...
void MX_FSMC_Init(void)
{
  ...
  */
  ...
  /* hnor3.Init */
  hnor3.Init.NSBank = FSMC_NORSRAM_BANK2;
  ...
  hnor3.Init.BurstAccessMode = FSMC_BURST_ACCESS_MODE_ENABLE;
  hnor3.Init.WaitSignalPolarity = FSMC_WAIT_SIGNAL_POLARITY_LOW;
  hnor3.Init.WrapMode = FSMC_WRAP_MODE_DISABLE;
  hnor3.Init.WaitSignalActive = FSMC_WAIT_TIMING_BEFORE_WS;
  hnor3.Init.WriteOperation = FSMC_WRITE_OPERATION_DISABLE;
  hnor3.Init.WaitSignal = FSMC_WAIT_SIGNAL_DISABLE;
  hnor3.Init.ExtendedMode = FSMC_EXTENDED_MODE_DISABLE;
